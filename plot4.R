...
#plot1
plot(x= data_frame$DateTime, y=data_frame$Global_active_power, type='line', lty=1, lwd=1, xlab='' ,ylab='Global Active Power')
...
#plot3
plot(x= data_frame$DateTime, y=data_frame$Voltage, type='line', lty=1, lwd=1, xlab='datetime' ,ylab='Voltage')

#plot4
plot(x= data_frame$DateTime, y=data_frame$Global_reactive_power, type='line', lty=1, lwd=1, xlab='datetime' ,ylab='Global_reactive_power')
